...
class EstatutosSociedadForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            'forma_legal': forms.TextInput(attrs={'class': 'form-control'}),
            'nacionalidad': forms.TextInput(attrs={'class': 'form-control'}),
            'capital_fijo_monto': forms.NumberInput(attrs={'class': 'form-control', 'step': '0.01'}),
            'capital_fijo_texto': forms.TextInput(attrs={'class': 'form-control'}),
            ...
            'libro_registro_acciones': forms.TextInput(attrs={'class': 'form-control'}),
            'periodicidad_asamblea': forms.TextInput(attrs={'class': 'form-control'}),
            'ejercicio_inicio': forms.TextInput(attrs={'class': 'form-control'}),
            'ejercicio_fin': forms.TextInput(attrs={'class': 'form-control'}),
